...
from . import M3ierpoolConfigEntry
...
async def async_setup_entry(
    hass: HomeAssistant,
    config_entry: M3ierpoolConfigEntry,
    ...
    binary_sensors = [
        PoolClimate(coordinator, device)
...
class PoolClimate(CoordinatorEntity, ClimateEntity):
    ...
    def device_class(self) -> str:
        ...
        return ClimateDeviceClass.DOOR
